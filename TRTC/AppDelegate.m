...
//    [manager setEnv:1];
    ...
    UINavigationController *nav = [[UINavigationController alloc] initWithRootViewController:[TCLiveRoomListViewController new]];
...
- (void)applicationDidEnterBackground:(UIApplication *)application {
    ...
    [ILiveLogReport reportEvent:1201 retTime:0 eventTime:dateTime roomId:0 extInfo:nil code:0 msg:nil];
}
