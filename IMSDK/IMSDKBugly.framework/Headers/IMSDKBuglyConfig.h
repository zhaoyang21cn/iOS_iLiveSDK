...
/**
 *  设置 App Groups Id (如有使用 IMSDKBugly iOS Extension SDK，请设置该值)
 */
 ...
 *  IMSDKBugly Delegate
 */
@property (nonatomic, assign) id<IMSDKBuglyDelegate> delegate;

/**
 * 控制自定义日志上报，默认值为IMSDKBuglyLogLevelSilent，即关闭日志记录功能。
 * 如果设置为IMSDKBuglyLogLevelWarn，则在崩溃时会上报Warn、Error接口打印的日志
 */
@property (nonatomic, assign) IMSDKBuglyLogLevel reportLogLevel;
