...
//  Version: 2.6.0(3)
//
//  Copyright (c) 2017年 Bugly. All rights reserved.
//

#import <Foundation/Foundation.h>

#import "IMSDKBuglyConfig.h"
...
/**
 *  初始化IMSDKBugly,使用默认IMSDKBuglyConfig
 *
 *  @param appId 注册IMSDKBugly分配的应用唯一标识
 */
 ...
 *
 *  @param appId 注册IMSDKBugly分配的应用唯一标识
 *  @param config 传入配置的 IMSDKBuglyConfig
 */
+ (void)startWithAppId:(NSString * BLY_NULLABLE)appId
                config:(IMSDKBuglyConfig * BLY_NULLABLE)config;
