...
@interface TILLiveUpVideoOption : NSObject

@property (nonatomic, strong) NSString *role;//必填
@property (nonatomic, assign) BOOL openMic; //默认开启
@property (nonatomic, assign) BOOL openCamera;//默认开启

+ (instancetype)defaultUpVideoOption:(NSString *)role;
@end
